...
<fieldset>
<legend style="color:black;"><b>PAYMENT PORTAL</b></legend>
<table style="padding:15px;">
<tr>
 <td><b>Request Id:</b></td>
 <td><select style="padding:5px;" name="sp_part">
 	...
 	include 'dbcon.php';
 	 if ($conn->connect_error) {
         ...
         $sql = "SELECT * FROM cust_req where client_id='$cname' && status='confirmed'";
