...
<center>
	...
	<div id="right-div" style="border:1px dashed black;">
		<h2 style="text-align:center">CLIENT PANEL</h2>
	<ul style="color:black ;text-decoration:none; color: white;">
            <li><a href="order.php">ORDER PRODUCT</a></li><br/>
            <li><a href="checkstatus.php"> CHECK STATUS</a></li></br>
            <!--<li><a href="pay.php">PAYMENT</a></li><br/>-->
