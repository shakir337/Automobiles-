...
<form action="orderraw1.php" method="post">

<fieldset>
<legend style="color:black;"><b>Order Raw Material</b></legend>
<table style="padding:15px;">
<tr>
 <td><b>MATERIAL NAME:</b></td>
 <td><select style="padding:5px;" name="m_name">
	...
	<option><?php echo $row["m_name"];?></option>
	<?php } 
		$conn->close();
...
<tr>
	...
	<td>
		<input type="text" name="quantity" placeholder="IN TONNES">
	</td>
</tr>
